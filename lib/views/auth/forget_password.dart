    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("نسيت كلمة المرور", style: GoogleFonts.abel(fontSize: 18, color: dark, fontWeight: FontWeight.bold)),
          elevation: 5,
          shadowColor: dark,
        ),
        body: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Center(child: Transform.rotate(angle: -pi / 6, child: Image.asset("assets/icons/lock.png", width: 150, height: 150))),
              const SizedBox(height: 40),
              Center(
                child: Text(
                  "الرجاء إدخال رقم هاتفك للحصول على رمز التحقق",
